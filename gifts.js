const gifts = {
  ...
  massiveevasion: {
    ...
    heals: [],
    description:
      "Replaces Full Unit Dodge. The character may roll a 1d3+1 to see how far they are able to jump. The character may choose any number of units to move, up to the number they rolled. The character lands on their feet after they leap to safety, but may still trigger Opportunity. Two uses per round.",
  },
  rushiii: {
    giftID: "rushiii",
    name: "Rush III",
  ...
  spunk: {
    ...
    cost: 3,
    stackMax: 1,
    requiredSkills: [{ skillID: "agility", level: 40 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+25 to Stamina, +2 to INI.",
  },
  beat: {
    giftID: "beat",
    name: "Beat",
  ...
  aggression: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "authority", level: 15 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+3 to INI.",
  },
  impactii: {
    giftID: "impactii",
    name: "Impact II",
  ...
  resolve: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "authority", level: 20 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Willpower.",
  },
  confidence: {
    giftID: "confidence",
    name: "Confidence",
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "authority", level: 25 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Charisma.\t",
  },
  valorous: {
    giftID: "valorous",
    name: "Valorous",
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "authority", level: 30 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Courage.",
  },
  responsibility: {
  ...
  gloriouspresence: {
    ...
    heals: [],
    description:
      "The user may choose to significantly increase the effectiveness of one of these abilities, once per day. To do this they must spend [10SN]: Demoralize If successful the target takes 2d6 Stun and loses 6d20 to their next roll. Rally Cry Allies also gain +2d20 to Spell Resist, Block, Deflect, Dodge, Catch and Willpower for 3 rounds. Encourage Heals for [10d20 + 2x Charisma] as Stamina. Hype\nYour target is granted one reroll (may choose whichever is higher) on the roll of their choice and adds 4d20 to their higher roll. Inspire\nHeals [20d20 + 3x User’s Charisma] to Stamina and 2d3 to Sanity. Ridicule All rolls by the target’s use 4d20 for one round. Confront/Deathwish\nLasts 3 rounds. During this time, enemies affected cannot deal critical strikes.",
  },
  scan: {
    giftID: "scan",
    name: "Scan",
  ...
  weaken: {
    ...
    heals: [],
    description:
      "Glyph: This glyph allows a spell’s power and effects to be greatly reduced. Using Weaken refunds up to 5SN from the total cost of the spell. If Weaken is used on a spell with Magnify I, the Weaken overrides it. However, Magnify II may override Weaken. Weaken may alternatively be used to cancel a spell’s remaining duration - but only if the caster of the rune is the same as the caster of Weaken.\nTypically the spell is considered to have no significant functionality, but allows many minor actions to be performed. For example, Conjure Fire would create a tiny flame, equivalent to a match (which can be used to light a fire). ",
  },
  alert: {
    giftID: "alert",
    name: "Alert",
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "awareness", level: 10 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  visionary: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "awareness", level: 20 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+5 to Authority, Charisma, and Courage.",
  },
  formtofitii: {
    giftID: "formtofitii",
    name: "Form to Fit II",
  ...
  wisdom: {
    ...
    cost: 3,
    stackMax: 1,
    requiredSkills: [{ skillID: "awareness", level: 25 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+25 to Sanity.",
  },
  innersight: {
    giftID: "innersight",
    name: "Inner Sight",
  ...
  braced: {
    ...
    heals: [],
    description:
      "When riding, driving, or as a passenger on any vessel, tamed animal, or vehicle, the character no longer has negatives to aiming while attacking. In addition, the character may use Reflex (Agility) if their mount or vehicle is moving (this applies only as long as their opponent is not on the same mount or vehicle).",
  },
  cautious: {
    giftID: "cautious",
    name: "Cautious",
    ...
    damages: [],
    heals: [],
    description: "+5 to Stealth, Agility, and Tactics.",
  },
  prevention: {
    giftID: "prevention",
    name: "Prevention",
  ...
  solid: {
    ...
    damages: [],
    heals: [],
    description: "+5 to Toughness, Willpower, and Leg Muscle.",
  },
  carefulaim: {
    giftID: "carefulaim",
    name: "Careful Aim",
  ...
  delicatestance: {
    ...
    heals: [],
    description:
      "The character always receives two rolls (and may choose the highest) when they are rolling for orientation and defense maneuvers against any sprung trap. In addition, the character’s steps are so careful that they gain +100 against anyone attempting to track them and do not make any noise.",
  },
  lag: {
    giftID: "lag",
    name: "Lag",
  ...
  steady: {
    ...
    cost: 5,
    stackMax: 1,
    requiredSkills: [{ skillID: "balance", level: 40 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+2 to Stamina Multiplier and +3 Sanity Regen.",
  },
  unstoppable: {
    giftID: "unstoppable",
    name: "Unstoppable",
  ...
  hype: {
    ...
    heals: [],
    description:
      "The user is able to hype up an ally for a maneuver, as long as the ally is within hearing range. The user may use this action at any time for 2PT. The target ally receives 2d20 to a maneuver of their choice. This may be used once per round per target. Target remains hyped and may wait to use this bonus for up to one hour. Each target may only have one use of Hype queued at a time.",
  },
  inspire: {
    giftID: "inspire",
    name: "Inspire",
  ...
  ridicule: {
    ...
    heals: [],
    description:
      "The user ridicules a target. The user may use this action at any time for 3PT and force their target to roll 4d20 instead of their next d100. This may only be used once per target per turn. Note: natural roll ranges still apply (so this disables the target from making a critical but also greatly lowers their fumble chance). If used against a defense, it loses it’s +50 and the target must roll.",
  },
  wordsmith: {
    giftID: "wordsmith",
    name: "Wordsmith",
    ...
    damages: [],
    heals: [],
    description: "Encourage now heals for twice as much.",
  },
  gentle: {
    giftID: "gentle",
    name: "Gentle",
    ...
    damages: [],
    heals: [],
    description: "+10 to Meditation/Rest.",
  },
  impressiveego: {
  ...
  savant: {
    ...
    heals: [],
    description:
      "Character may choose only one: Discourage Encourage may now also be used to damage an enemy (for the same amount as it would have healed an ally). Empassion Encourage heals for three times as much and Inspire heals for twice as much. (replaces Wordsmith).\t Glorify Hype may optionally apply to all allies nearby, but it costs 2SN per ally affected. ",
  },
  optimistic: {
    giftID: "optimistic",
    name: "Optimistic",
  ...
  humble: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "charisma", level: 35 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Authority.\t",
  },
  zeal: {
    giftID: "zeal",
    name: "Zeal",
  ...
  intensifyi: {
    ...
    heals: [],
    description:
      "Glyph: This glyph allows the caster to add a Charisma or Authority maneuver to their next spell without spending the PT normally required. The maneuver takes the form of a sensory experience.  What this means is that the caster may choose to make the spell blinding in brightness, explosively loud, alluring in scent, horrific in taste, or wonderful feeling. The more creative, the better!\nThe added maneuver becomes a Courage or Willpower check that must be passed by anyone who hears, sees, smells, tastes, or feels the Intensified spell being cast.\nSight, Sound, and Smell have a natural radius of 5 units from the target location of the spell. Others can still notice the spell effect outside this radius, but they are not subject to a Courage or Willpower check. Taste and Touch only affect one target but make up for it by being extra intense, adding +2d20 to the maneuver. If this glyph is used with a Whispered spell, it does not add a radius to the base spell but simply an additional Charisma or Authority maneuver to it as the glyph explains. Intervene - (Ability)\t\nCharacter may use Move when it is not their turn to obstruct an attack or defend someone else. They spend [20 Stamina] per Move.",
  },
  overcoming: {
    giftID: "overcoming",
    name: "Overcoming",
    ...
    cost: 3,
    stackMax: 1,
    requiredSkills: [{ skillID: "courage", level: 15 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  fortitudei: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "courage", level: 20 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Sanity, +10 to Death Health.",
  },
  ...
  hardwroughti: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "craftiness", level: 5 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+35 to Stamina.",
  },
  novicei: {
    giftID: "novicei",
    name: "Novice I",
  ...
  smallcraft: {
    ...
    heals: [],
    description:
      "User may create a tiny-category, generic item (such as an arrow, pouch, or token) from inferior resources, with up to one resource or tool missing. (Examples include: a functional arrow without a feather, a leather pouch held together without a string, or carving a little statue without a woodknife).",
  },
  dismantle: {
    giftID: "dismantle",
    name: "Dismantle",
  ...
  materialism: {
    ...
    damages: [],
    heals: [],
    description: "+10 to Alchemy Lore",
  },
  noviceiii: {
    giftID: "noviceiii",
    name: "Novice III",
  ...
  cleverness: {
    ...
    damages: [],
    heals: [],
    description: "+10 bonus to one Art of choice.",
  },
  different: {
    giftID: "different",
    name: "Different",
  ...
  quirky: {
    ...
    stackMax: 1,
    requiredSkills: [{ skillID: "craftiness", level: 30 }],
    requisiteGifts: ["different"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+7 Shape Points.",
  },
  experti: {
    giftID: "experti",
    name: "Expert I",
    ...
    requisiteGifts: ["intermediateiii"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
  ...
  eccentric: {
    ...
    requisiteGifts: ["quirky"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+12 Shape Points.",
  },
  elevate: {
    giftID: "elevate",
    name: "Elevate",
  ...
  master: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "craftiness", level: 45 }],
    requisiteGifts: ["expertii"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+30 to a Secondary Art.",
  },
  resolution: {
    giftID: "resolution",
    name: "Resolution",
  ...
  nimble: {
    ...
    damages: [],
    heals: [],
    description: "+5 to Stealth, Agility, and Balance.",
  },
  surgical: {
    giftID: "surgical",
    name: "Surgical",
  ...
  accurate: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "dexterity", level: 30 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Missile/Thrown.",
  },
  pierce: {
    giftID: "pierce",
    name: "Pierce",
  ...
  precise: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "dexterity", level: 35 }],
    requisiteGifts: ["accurate"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+5 to all Weapons and Hand to Hand.",
  },
  ambidexterity: {
  ...
  forcedaim: {
    ...
    heals: [],
    description:
      "By spending [1d6SN] the character avoids Evasion negatives to their next attack. The character must already be holding onto the body part they wish to strike. If the character is using a spell, they only need to be touching what they wish to cast a spell on instead. Note: Direct or Trigger Touch is still required.",
  },
  cadence: {
    giftID: "cadence",
    name: "Cadence",
  ...
  durationi: {
    ...
    heals: [],
    description:
      "Glyph: This glyph allows a spell’s effect to linger. Most spells are very short in their duration, and this glyph allows a spell’s effects to last for 1 additional duration for every stack used (for example, a spell that normally lasts 5 minutes would last ten more minutes if two stacks were expended by the caster). Each stack costs 6SN. If a spell does not have a duration, but rather an instant effect (like Conjure Fire), then the spell effectively reapplies its effects once every round. Some creativity may be used here, because a Fire that has Duration might leave a lingering flame which burns the target further for the remainder of the time. During the additional time, the spell is half as effective. This glyph may be “stacked” or stored up to 10 times, costing 6SN per stack. Note: Channeled runes and runes with special casting times may interact differently with this glyph.",
  },
  impacti: {
    giftID: "impacti",
    name: "Impact I",
  ...
  bounce: {
    ...
    heals: [],
    description:
      "Glyph: This glyph requires that the caster also uses a Duration Glyph. This glyph replaces the duration of a spell with a bounce-effect instead. This glyph cannot be used with social spells. Bounce will change all stacks of Duration that the caster uses into randomly chosen “bounces” to a new target. The bounce will find a target in range, relative to the last target it hit (range is determined by whether or not Range glyph is used). The caster must specify when casting if they wish to exclude themselves as a target for the bounce, as they are considered a possible target by default.\nEach stack of Duration equates to one bounce to a new target. The bounce effect cannot be controlled by the caster, it is random. The original target of the spell may be cast on in any way (portaled, flung, trapped, etc), but all subsequent bounce effects are considered flung, using the caster’s original spell casting value as the value for each new bounce cast. If one of the bounces of the spell are dodged, the spell will simply arc toward its next target (but still expend one charge). The bouncing spell will continue to bounce until it runs out of charges.\nThe caster cannot mix and match Duration effects with Bounce effects unless they have Duration III. For Duration I and II, every bounce (after the first target) is 50% as effective in power (in the same way that Duration stacks are 50% as effective). This cannot be used with Cone or Radius.",
  },
  "trigger:touch": {
  ...
  cone: {
    ...
    heals: [],
    description:
      "The spell cast creates a cone from its target, in a direction specified by the caster. All targets within the cone are dealt the effects of the spell, but at 50% strength. The length of the cone is 3d3-1 units with a 1d3+1 peak width. If Direct is used, the caster can specify if they are affected or not. If Direct is not used, then the caster is affected by the spell and the direction is random. The caster must choose a target for the source of the area. If the caster uses their target as a spell portal or flings their spell at the target, all other entities within range effectively have the spell flung at them (because the spell bursts forth from the original target). The caster’s original spell casting value is the value made against all targets within the area. If this was used with a whispered spell, then it whispers on all targets within the area.\nSome spells are affected differently by this glyph, while a few may not be compatible. This cannot be used with Bounce or Radius.",
  },
  directii: {
    giftID: "directii",
    name: "Direct II",
  ...
  durationii: {
    ...
    heals: [],
    description:
      "Glyph: Replaces Duration I. This glyph is the same as Duration I, but it allows a spell’s effects to last for 1 additional duration for every 4SN spent. Also, this glyph may be reapplied to a spell that has already been cast before the spell’s Duration ends. This reapplication may happen so long as a Duration glyph was first used when the spell was originally cast. If the caster themselves originally cast the spell that they are reapplying Duration to, their target does not need to be in sight or range in order to renew Duration. Duration II may be stored with up to 20 stacks.",
  },
  "enchant:charge": {
  ...
  conceal: {
    ...
    heals: [],
    description:
      "Note: This gift may be purchased without the Stealth requisite for 6 more Gift Points. This gift allows glyphs to be prepared and stored without external expression (they can be prepared silently and mentally). Essentially, the caster can think their glyphs rather than writing, saying, or emoting them. Concealing any glyph increases the SN cost of that glyph by 1. Glyphs that are already stored do not need to be concealed in order to be used. In addition, Whispered Runes may be cast Telepathically so long as all of their glyphs were Concealed. This is equivalent to a Sneak maneuver/attack. Memorized runes that are Portaled or Flung also gain this advantage. Normal sneaking rules apply: target has one Perception roll per round. If their Awareness fails, they are unaware of where the spell came from and cannot use defenses against it.",
  },
  containi: {
    giftID: "containi",
    name: "Contain I",
  ...
  reverse: {
    ...
    heals: [],
    description:
      "Glyph: This glyph allows the reverse of a rune to be cast in a spell. This glyph creates very complex spells, and each spell has a specific reverse effect (refer to the reverse of a rune in a runebook). If the resources available to the caster (typically a runebook) do not specify if a rune of theirs has a reverse, the caster cannot use this glyph (of course, the reverse rune may exist somewhere else).",
  },
  ruminate: {
    giftID: "ruminate",
    name: "Ruminate",
  ...
  magnifyii: {
    ...
    heals: [],
    description:
      "Glyph: Replaces Magnify I. This glyph is the same as Magnify I, except that it also doubles the effects of the following glyphs: Duration, Impact, Intensify, Range, Cone, and Radius. Cone, Duration, and Radius still deal reduced damage, but their base effects are doubled. In addition, this glyph will now override Weaken if used together.",
  },
  rangeiii: {
    giftID: "rangeiii",
    name: "Range III",
  ...
  "trigger:sense": {
    ...
    heals: [],
    description:
      "Glyph: This glyph functions in the same way as Trigger: Touch, except that any other sense may be chosen as a trigger. The caster must specify what sense will trigger the stored spell. If the caster uses Magnify with this glyph, they may choose two senses instead of only one. The first entity to hear, smell, see, or taste the object will trigger it (but those presently doing so during the casting of this glyph are exempt from trigger it until they avert their sense and then sense the objet again). This glyph will only trigger for targets within range of the stored spell, according to whether or not Range glyph was used.",
  },
  attuned: {
    giftID: "attuned",
    name: "Attuned",
    ...
    heals: [],
    description:
      "Caster may add their own glyphs to another caster’s spell. The caster cannot change or alter the glyphs already in place or add a glyph that has already been added. The caster must roll to identify the spell they are attempting to glyph. The other spell must be cast within sight. If the other spell is being cast from memory (not read from a runebook), the caster must be able to access the thoughts of their target caster in order to identify the spell being cast. In addition, a spell that casts from a trigger or enchantment must be identified before it begins casting, or else the caster will be unable to enhance it.",
  },
  containii: {
    giftID: "containii",
    name: "Contain II",
  ...
  durationiii: {
    ...
    heals: [],
    description:
      "Glyph: Replaces Duration II. This glyph is the same as Duration II, but the additional rounds of the spell are fully effective. Also, if used with Bounce, the caster may specify if their spell bounces or applies Duration on their target. (The caster may mix and match duration and bounce.)",
  },
  quicken: {
    giftID: "quicken",
    name: "Quicken",
  ...
  permanence: {
    ...
    heals: [],
    description:
      "Glyph: This glyph allows the effects of the spell being cast to be permanent in duration. (This glyph cannot be used with Contain I or II. This glyph also cannot be stored.) This glyph (not including the rune itself) takes hours to cast equal to the total SN cost of the spell. (If the spell costs 18SN, it will take 18 hours just to cast this glyph.) The caster must remain in contact with whatever they are casting on for the full duration. A roll to successfully cast is made at the very end of the process. The caster must choose which type of Permanence to enhance a spell with: Permanent Creation or Permanent Casting. Not all spells may make sense with one or either of these modes of Permanence (but the player and host are encouraged to find creative uses). In addition to these two types below, some runes will already have rules in place for how Permanence will affect them. (The rune detail pages have thorough explanations.) The differences between Mundane and Arcane Permanence will be explained with Conjure Fire: Permanent Creation (called “Mundane”)\nA permanently conjured fire will be a real fire: it has the effects of a real fire, can be put out like a real fire, and must be treated as a regular fire would. The fire is not brought into the world with a powerful blast (like Conjure Fire normally is), but rather as a soft and wholesome flame. Some spells are quite useful with Mundane, while others are not. Conjure Bone will permanently graft bone to its subject, Counter Spell will permanently raise resistance slightly,  etc. Using Mundane Permanence multiplies the SN cost of the spell by five times. Permanent Casting (called “Arcane”)\nA permanently conjured fire will remain an open portal of flame from the essence realm. The conjured spell will only be half as powerful as the typical rune that cast it, but it will recast itself if its duration ever runs out. Essentially, this spell is cast with Duration II autonomously and forever. The danger of an Arcane Permanence is that this spell portal can be closed in any regular way: with Counter Spell, Dispel Essence, Dispel Fire, etc. Some spells are not as useful (or even make sense) with this, while others are awesome. If this spell succeeds in casting with Arcane Permanence, five times the total SN Cost of the spell is subtracted from the caster’s Maximum Sanity. If the Permanence is ever removed, dispelled, or otherwise cancelled by magical means, the maximum sanity does not return to the caster.",
  },
  prepare: {
    giftID: "prepare",
    name: "Prepare",
  ...
  conviction: {
    ...
    cost: 1,
    stackMax: 1,
    requiredSkills: [{ skillID: "meditationrest", level: 10 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  serenityi: {
    ...
    damages: [],
    heals: [],
    description: "+15 to Stamina, +5 to Sanity.\t",
  },
  secondwindi: {
    giftID: "secondwindi",
    name: "Second Wind I",
  ...
  absolution: {
    ...
    damages: [],
    heals: [],
    description: "Med/Rest total now adds to Stamina.",
  },
  serenityiii: {
    giftID: "serenityiii",
    name: "Serenity III",
  ...
  trustii: {
    ...
    stackMax: 1,
    requiredSkills: [{ skillID: "meditationrest", level: 20 }],
    requisiteGifts: ["trusti"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+6 Shape Points.",
  },
  fast: {
    giftID: "fast",
    name: "Fast",
  ...
  engaged: {
    ...
    damages: [],
    heals: [],
    description: "+5 to Agility, Courage, and Balance.",
  },
  serenityiv: {
    giftID: "serenityiv",
    name: "Serenity IV",
  ...
  knowledge: {
    ...
    damages: [],
    heals: [],
    description: "+5 to Awareness and Tactics.",
  },
  serenityv: {
    giftID: "serenityv",
    name: "Serenity V",
  ...
  trustiii: {
    ...
    stackMax: 1,
    requiredSkills: [{ skillID: "meditationrest", level: 30 }],
    requisiteGifts: ["trustii"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+8 Shape Points.",
  },
  theflow: {
    giftID: "theflow",
    name: "The Flow",
  ...
  strategization: {
    ...
    heals: [],
    description:
      "Prepare now costs 0PT and does not lengthen the time it takes to perform an action. In addition, Prepare may be used an additional time per round for every other character that gets a turn before the character receives theirs. Prepare may be used multiple times for a single action or spread across actions during the turn.",
  },
  tranquility: {
    giftID: "tranquility",
    name: "Tranquility",
  ...
  trustiv: {
    ...
    stackMax: 1,
    requiredSkills: [{ skillID: "meditationrest", level: 35 }],
    requisiteGifts: ["trustiii"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 Shape Points, +1 Plot Point.",
  },
  secondwindiii: {
  ...
  shredded: {
    ...
    cost: 3,
    stackMax: 1,
    requiredSkills: [{ skillID: "armmuscle", level: 40 }],
    requisiteGifts: ["mightmakesright"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+15 to Authority.",
  },
  charge: {
    giftID: "charge",
    name: "Charge",
    ...
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: "20Stam per Move",
    damages: [],
    heals: [],
    description:
      "The first melee attack made each round (if the character is Sprinting or Riding) adds the character’s Leg Muscle Total to Stamina Damage dealt. Tactical Shift - (Ability)\nCharacter may move one additional unit for free each turn. This free move does not add “Moving” status. In addition, Tactical Shift may be used to strafe near an enemy without triggering an Opportunity as long as the character does not move out of melee reach. Intervene - (Ability)\t\nCharacter may use Move when it is not their turn to obstruct an attack or defend someone else. They spend [20 Stamina] per Move.",
  },
  coresynergistics: {
  ...
  rushi: {
    ...
    damages: [],
    heals: [],
    description: "+1 to Move distance. Represented as 4:[x].",
  },
  flee: {
    giftID: "flee",
    name: "Flee",
  ...
  forerunner: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "legmuscle", level: 20 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  plyometrics: {
    ...
    damages: [],
    heals: [],
    description: "+25 to Stamina, +10 to Agility.",
  },
  unburdened: {
    giftID: "unburdened",
    name: "Unburdened",
    ...
    damages: [],
    heals: [],
    description: "+1 is added to ENC Mult.",
  },
  rushii: {
    giftID: "rushii",
    name: "Rush II",
    ...
    stackMax: 1,
    requiredSkills: [{ skillID: "legmuscle", level: 20 }],
    requisiteGifts: ["rushi"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+1 to Move distance. Represented as 5:[x].",
  },
  lightstep: {
    giftID: "lightstep",
    name: "Light Step",
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "legmuscle", level: 25 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+5 to Stealth and Balance.",
  },
  increasedmass: {
  ...
  rushiv: {
    ...
    cost: 4,
    stackMax: 1,
    requiredSkills: [{ skillID: "legmuscle", level: 40 }],
    requisiteGifts: ["rushiii"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+1 to Move distance. Represented as 7:[x].",
  },
  dash: {
    giftID: "dash",
    name: "Dash",
    ...
    heals: [],
    description:
      "Character may use an additional Move once per round whether or not it is their turn, by spending [5SN] (in addition to Move’s normal cost). This use of Move does not count towards the character’s maximum use of Move (typically a character is only allowed to use Move three times per turn).",
  },
  ambush: {
    giftID: "ambush",
    name: "Ambush",
    ...
    heals: [],
    description:
      "+10 bonus to Aim for the character’s next attack, if it is a Sneak Attack. If Ambush hits its target, then the character gains +10 to Initiative. This bonus to Initiative may only be granted once. Sleight of Hand - (Ability)\nThe character spends 2SN and 3PT to use their Dexterity to distract someone’s attention from their next move. The character’s next roll adds their Dexterity total. However, all affected target or targets add their Awareness in addition to whatever else they would already use against the character’s maneuver.\nThe Dexterity bonus may only be added against targets that can be tricked by sight or sound and the character must specify if they are using a visual or a vocal distraction beforehand. ",
  },
  subtlety: {
    giftID: "subtlety",
    name: "Subtlety",
    ...
    cost: 1,
    stackMax: 1,
    requiredSkills: [{ skillID: "stealth", level: 10 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+10 to Balance.\t",
  },
  unseenmove: {
    giftID: "unseenmove",
    name: "Unseen Move",
    ...
    heals: [],
    description:
      "The character spends [1d6SN] to deal double Trauma Effects on the Trauma Table for their next attack (doubling is additive). This is only usable if the character’s attack can be considered a Sneak Attack. The resources must be spent before the attack is attempted (this cannot be used after an attack has been initiated and rolled for).",
  },
  mystique: {
    giftID: "mystique",
    name: "Mystique",
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "stealth", level: 25 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  exploitweakness: {
    ...
    heals: [],
    description:
      "The character doubles the PT cost of their next attack and it ignores all armor. This is only usable if the character’s attack can be considered a Sneak Attack. The resources must be spent before the attack is attempted (this cannot be used after an attack has been initiated and rolled for).",
  },
  perfecttension: {
    ...
    heals: [],
    description:
      "The character no longer receives armor negatives to stealth when wearing metal armor. If the character chooses, they may avoid the Form to Fit III requirement by spending 4 more Gift Points. Tactical Shift - (Ability)\nCharacter may move one additional unit for free each turn. This free move does not add “Moving” status. In addition, Tactical Shift may be used to strafe near an adjacent enemy without triggering an Opportunity as long as the character remains adjacent. Tactical Shift may be used to Climb, Jump, or Swim.",
  },
  confront: {
    giftID: "confront",
    name: "Confront",
  ...
  calculated: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "tactics", level: 15 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  firststrike: {
    ...
    heals: [],
    description:
      "Character has 6 free PT to use before Initiative begins in combat. If multiple characters have First Strike, the Initiative Roll decides who gets to use First Strike: the highest roller wins. (Only one character, friend or foe, can use First Strike before combat officially begins.) The actions spent during this time serve as an extension of the character’s first turn.",
  },
  intuition: {
    giftID: "intuition",
    name: "Intuition",
  ...
  stoici: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "toughness", level: 10 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
    description: "+25 to Death Health, +5 to Sanity.",
  },
  coarseskin: {
    giftID: "coarseskin",
    name: "Coarse Skin",
    ...
    damages: [],
    heals: [],
    description: "Adds +0/5% to MIT constantly.",
  },
  ruthlessnessii: {
  ...
  starkskin: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "toughness", level: 35 }],
    requisiteGifts: ["roughskin"],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
    heals: [],
  ...
  abuse: {
    ...
    heals: [],
    description:
      "If the user has already made an attack against an opponent, they may use this ability. This gift allows the next attack made by the character to have a much better chance to hit the exact same location as their previous attack. This gift removes all evasion and agility penalties when aiming. (The target still may choose to defend themselves.) ",
  },
  counter: {
    giftID: "counter",
    name: "Counter",
  ...
  junkyardfighting: {
    ...
    heals: [],
    description:
      "Any ranged or melee weapon or attack may be used with 25 less than the character’s highest Weapon Art. (Example: a chair, 1-H sword, punch, crossbow, spear, etc may be used with an attack of 50 Art Total if the character has 75 in their highest Weapon Art.) Item Bonuses that contribute to the character’s highest Weapon Art Total are not included in this calculation.",
  },
  riposte: {
    giftID: "riposte",
    name: "Riposte",
  ...
  masteroffinesse: {
    ...
    heals: [],
    description:
      "If the character rolls a critical when using Counter, Riposte, or Interrupt, the potential cost of the attack is refunded. These moves cannot fumble. If a fumble is rolled, a critical is calculated instead. In addition, if the character rolls a critical when using Opportunity, they may use another Opportunity. ",
  },
  unlimitedability: {
  ...
  confident: {
    ...
    cost: 1,
    stackMax: 1,
    requiredSkills: [{ skillID: "willpower", level: 10 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  rugged: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "willpower", level: 30 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
  ...
  intensity: {
    ...
    cost: 2,
    stackMax: 1,
    requiredSkills: [{ skillID: "willpower", level: 40 }],
    requisiteGifts: [],
    requisiteAbilitiesForUse: [],
    useCost: [],
    damages: [],
